...
public class Jotto {
	...
	private Vector<String> anagrams_;
	...
	private void initialize() {
		...
		JMenu mnJotto = new JMenu("Jotto");
		menuBar.add(mnJotto);

		JMenuItem mntmLoadWordList = new JMenuItem("Load word list...");
		...
		JMenuItem mntmLoadJottoFile = new JMenuItem("Load Jotto file...");
